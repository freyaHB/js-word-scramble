...
let index1 = getRandomInt(0, myArray.length-1);
let index2 = getRandomInt(0, myArray.length-1);

function swapNumbers(index1, index2, myArray) {
...
swapNumbers(index1, index2, myArray); 
